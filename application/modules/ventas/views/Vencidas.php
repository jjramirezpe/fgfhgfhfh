...
<div class="container-fluid">
	...
	<ul class="nav nav-tabs">
	  ...
	  <li class="active"><a href="<?php echo base_url('ventas/vencidas');?>">Vencidas</a></li>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({  
        ...
        "ajax": {
            "url": "<?php echo site_url('ventas/ver_facturas_vencidas')?>",
            "type": "POST"
        },
        ...
        "language": {
            ...
            "sZeroRecords":    "No se encontraron facturas vencidas",
