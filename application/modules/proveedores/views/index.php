...
<div class="container-fluid">
  ...
  <li class="active"><a href="<?php echo base_url('proveedores')?>">Proveedores</a></li>
...
<button onclick="add_person()"  type="button" class="btn btn-danger spacer-top spacer-bottom">Nuevo Proveedor</button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title text-center">Nuevo Proveedor</h4>
      </div>
      <div class="modal-body">
        <p>Añade nuevos Proveedores al sistema</p>
        <form action="#" id="form">
          <input type="hidden" value="" name="id_proveedor"/> 
        <div class="row">
          <div class="col-md-6">
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({  
        ...
        "ajax": {
            "url": "<?php echo site_url('proveedores/ajax_list')?>",
            "type": "POST"
        },
        ...
        "language": {
            ...
            "sInfo":           "Proveedores registrados  _TOTAL_ ",
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('proveedores/ajax_edit/')?>/"+id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('proveedores/ajax_add')?>";
    } else {
        url = "<?php echo site_url('proveedores/ajax_update')?>";
    }
...
function delete_person(id)
{
    if(confirm('Esta seguro de Eliminar este proveedor?. No podra recuperarlo de nuevo!'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('proveedores/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
